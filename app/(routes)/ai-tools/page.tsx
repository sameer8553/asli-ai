...
import { FiMessageSquare, FiCode, FiHelpCircle, FiBriefcase } from 'react-icons/fi';

export default function AIToolsPage() {
  const tools = [
    {
      title: 'AI Doubt Solver',
      description: 'Ask any programming doubt and get instant solution in Hinglish',
    ...
    },
    {
      ...
      description: 'Paste any code and get step-by-step explanation in simple language',
      icon: FiCode,
      color: 'bg-blue-500',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn programming faster with our AI tools. Get instant help, explanations, and practice.
          </p>
        </div>
